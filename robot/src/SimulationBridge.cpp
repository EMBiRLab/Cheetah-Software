...
void SimulationBridge::runRobotControl() {
  if (_firstControllerRun) {
    ...
    _robotRunner->robServData = &_sharedMemory().simToRobot.robServData;
    ...
    _robotRunner->robServCommand = &_sharedMemory().robotToSim.robServCommand;
