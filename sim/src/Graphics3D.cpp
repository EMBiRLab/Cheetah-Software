...
/*!
 * Configure the window for displaying muadquad
 */
size_t Graphics3D::setupMuadQuad(Vec4<float> color, bool useOld, bool canHide) { return _drawList.addMuadQuad(color, useOld, canHide); }
